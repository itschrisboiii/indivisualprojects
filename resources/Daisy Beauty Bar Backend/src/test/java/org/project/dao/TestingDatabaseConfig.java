...
public class TestingDatabaseConfig {
    ...
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "daisybeautybarTesting");
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource("daisybeautybar.sql"));
        return dataSource;
    }
